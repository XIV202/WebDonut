...
class WebDonutBrowser(QMainWindow):
    def __init__(self):
        ...
        self.add_new_tab(QUrl("https://xiv202.github.io/MainPageRu/"))
    ...
    def add_new_tab(self, qurl=None, label="Blank"):
        try:
            if qurl is None:
                qurl = QUrl('https://xiv202.github.io/MainPageRu/')
    ...
    def add_new_tab_incognito(self):
        ...
        incognito_browser.setUrl(QUrl('https://xiv202.github.io/MainPageRu/'))
    ...
    def navigate_home(self):
        self.current_tab().setUrl(QUrl("https://xiv202.github.io/MainPageRu/"))
